package com.audacious_software.passive_data_kit.location.generators;
...
import com.audacious_software.passive_data_kit.location.R;
...
public class GooglePlaces extends Generator {
    ...
    private static final String ENABLED = "com.audacious_software.passive_data_kit.location.generators.GooglePlaces.ENABLED";
    private static final boolean ENABLED_DEFAULT = false;

    private static final String DATA_RETENTION_PERIOD = "com.audacious_software.passive_data_kit.location.generators.GooglePlaces.DATA_RETENTION_PERIOD";
    private static final long DATA_RETENTION_PERIOD_DEFAULT = (60L * 24L * 60L * 60L * 1000L);

    private static final String API_KEY = "com.audacious_software.passive_data_kit.location.generators.GooglePlaces.API_KEY";

    private static final String AUTOMATICALLY_UPDATES = "com.audacious_software.passive_data_kit.location.generators.GooglePlaces.AUTOMATICALLY_UPDATES";
